...
def demo_1p5d_convex():
    """Demonstrate 1.5D convex array transducer."""
    print("\n" + "=" * 70)
    print("1.5D CONVEX ARRAY TRANSDUCER (NEW!)")
    print("=" * 70)
    ...
    # Element positions show curvature
    x_positions = tx.element_positions[:, 0]
    z_positions = tx.element_positions[:, 2]
    ...
    # 3D focusing
    focus_point = (0.0, 0.0, 0.03)
    delays = tx.delays_for_focus(focus_point)
    print(f"\nFocusing at ({focus_point[0]*1e3:.1f}, {focus_point[1]*1e3:.1f}, {focus_point[2]*1e3:.1f})mm:")
    print(f"  Delay range: [{delays.min()*1e6:.3f}, {delays.max()*1e6:.3f}]µs")
    
    print(f"\nApplications:")
    print(f"  • Cardiac imaging with wide field of view")
    print(f"  • Enhanced 2D imaging with elevation control")
    print(f"  • Deep tissue imaging with curved aperture")
    print(f"  • Combines benefits of 1.5D and convex arrays")


def demo_2d_convex():
    """Demonstrate 2D matrix convex array transducer."""
    print("\n" + "=" * 70)
    print("2D MATRIX CONVEX ARRAY TRANSDUCER (NEW!)")
    print("=" * 70)
    ...
    print(f"\nApplications:")
    print(f"  • 3D/4D cardiac imaging with wide FOV")
    print(f"  • Volumetric imaging with curved aperture")
    print(f"  • Deep tissue 3D imaging")
    print(f"  • Maximum flexibility in beam control")
...
def main():
    ...
    print("  ✓ ROC parameter for convex arrays (works with 1D, 1.5D, and 2D!)")
